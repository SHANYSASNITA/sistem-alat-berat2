...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title mb-4">Form Edit Harga Sewa (Pricing)</h6>
                    ...
                    <form action="{{ route('pricing.update', $data->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="berlaku_mulai" class="form-control @error('berlaku_mulai') is-invalid @enderror" value="{{ old('berlaku_mulai', $data->berlaku_mulai) }}" required>
                                @error('berlaku_mulai') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label">Berlaku Selesai</label>
                                <input type="date" name="berlaku_selesai" class="form-control @error('berlaku_selesai') is-invalid @enderror" value="{{ old('berlaku_selesai', $data->berlaku_selesai) }}">
