                        ...
                        <form action="{{ route('dp.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="p-3 bg-light rounded border mb-3">
                                ...
                                <div class="mb-2">
                                    ...
                                    <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" rows="2" placeholder="Contoh: DP Awal Proyek Tol, via BCA">{{ old('keterangan') }}</textarea>
                                </div>
                            </div>
