...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8 mx-auto stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title mb-4">Form Tambah Pembayaran</h6>
                    ...
                    <form method="GET" action="{{ route('dp.create') }}" class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Form input akan muncul setelah transaksi dipilih.</small>
                        </div>
                    </form>
                            ...
                            <div class="p-3 bg-light rounded border mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Tanggal DP Awal <span class="text-danger">*</span></label>
