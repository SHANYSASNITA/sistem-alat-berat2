            ...
            <div class="col-9">
                ...
                <nav class="site-navigation text-right d-none d-lg-block" role="navigation">
                    ...
                    <ul class="site-menu main-menu js-clone-nav d-flex justify-content-end align-items-center m-0 p-0 w-100">
                        ...
                        <li class="ml-4">
                            <a href="{{ route('penyewa.login') }}" class="btn btn-primary rounded-pill px-4 py-2 d-inline-flex align-items-center" style="color: black !important; font-weight: 700; text-decoration: none;">
